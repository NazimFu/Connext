                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                        We've received your verification request and our admin team is reviewing it.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                        You'll receive an email at <span className="font-medium text-amber-700">{user?.email}</span> once your account is approved.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6 space-y-3">
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>Our admin team will review your verification details</span>
                                </li>
                                <li className="flex items-start gap-2">
                                ...
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>After approval, you can access all mentorship features</span>
                                </li>
                            </ul>
                        </div>
